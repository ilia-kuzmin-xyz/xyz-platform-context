...
- **Asset import partial re-import data loss** — re-importing an `.xlsx` that updates a subset reportedly drops/overwrites existing assets. (`AssetImportPage/AssetImport.utils.ts`.) *Highest-value data-loss bug.*
