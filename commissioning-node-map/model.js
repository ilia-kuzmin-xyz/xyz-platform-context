const STAGES = [
  ...
  const TABLES = {
    bridge: {
      ...
      commissioning_file: { created_by: { t: 'string?' }, file_extension: { t: 'string?' }, file_name: { t: 'string' }, file_reference_id: { t: 'string' }, file_size_bytes: { t: 'number?' }, file_type: { t: 'string' }, id: { t: 'string' }, inserted_on: { t: 'string?' }, mime_type: { t: 'string' }, platform_environment: { t: 'string', fk: 'commissioning_project_file_scope' }, platform_project_id: { t: 'string', fk: 'commissioning_project_file_scope' }, project_id: { t: 'string', fk: 'commissioning_project_file_scope' }, registered_at: { t: 'string' }, registered_by: { t: 'string' }, sha256: { t: 'string?' }, sha256_provenance: { t: 'string?' }, size_provenance: { t: 'string?' }, xyz_display_name: { t: 'string?' } },
      commissioning_file_association: { asset_id: { t: 'string?', fk: 'asset' }, association_type: { t: 'string' }, created_at: { t: 'string' }, created_by: { t: 'string' }, document_revision_id: { t: 'string?' }, evidence_surface: { t: 'string?' }, execution_item_id: { t: 'string?', fk: 'task_execution_item' }, file_id: { t: 'string', fk: 'commissioning_file' }, id: { t: 'string' }, position: { t: 'number' }, project_id: { t: 'string', fk: 'commissioning_project_file_scope' }, reference_document_id: { t: 'string?' }, reference_owner_type: { t: 'string?' }, run_id: { t: 'string?', fk: 'commissioning_run_comparison_v1' }, signature_id: { t: 'string?', fk: 'task_execution_signature' }, system_id: { t: 'string?', fk: 'system' }, task_template_version_id: { t: 'string?', fk: 'task_template_version' } },
      commissioning_operation_receipt: { operation_id: { t: 'string' }, project_id: { t: 'string', fk: 'commissioning_project_file_scope' }, received_at: { t: 'string' }, request: { t: 'Json' }, response: { t: 'Json' } },
      commissioning_project_file_scope: { bound_at: { t: 'string' }, bound_by: { t: 'string' }, platform_environment: { t: 'string', fk: 'commissioning_project_file_scope' }, platform_project_id: { t: 'string', fk: 'commissioning_project_file_scope' }, project_id: { t: 'string', fk: 'commissioning_project_file_scope' } },
      ...
      commissioning_run_lifecycle_v1: { completed_at: { t: 'string?' }, failed_item_count: { t: 'number?' }, has_unresolved_conflict: { t: 'boolean?' }, is_current: { t: 'boolean?' }, outcome: { t: 'string?' }, project_id: { t: 'string?', fk: 'commissioning_project_file_scope' }, readiness_eligible: { t: 'boolean?' }, responses_locked_at: { t: 'string?' }, run_id: { t: 'string?', fk: 'commissioning_run_comparison_v1' }, run_revision: { t: 'number?' }, signoff_state: { t: 'string?' }, task_instance_id: { t: 'string?', fk: 'commissioning_run_lifecycle_v1' }, task_revision: { t: 'number?' }, task_status: { t: 'string?' } },
      ...
      task_execution: { completed_at: { t: 'string?' }, definition_sha256: { t: 'string?' }, definition_snapshot: { t: 'Json?' }, executed_by: { t: 'string' }, failed_item_count: { t: 'number?' }, id: { t: 'string', pk: 1 }, invalidated_at: { t: 'string?' }, outcome: { t: 'string?', en: ['complete', 'completeWithFailures', 'pass', 'passWithComments', 'fail'] }, outcome_note: { t: 'string?' }, responses_locked_at: { t: 'string?' }, revision: { t: 'number?' }, sequence: { t: 'number' }, started_at: { t: 'string' }, supersedes_run_id: { t: 'string?', fk: 'commissioning_run_comparison_v1' }, task_instance_id: { t: 'string', fk: 'commissioning_run_lifecycle_v1' }, task_template_version_id: { t: 'string?', fk: 'task_template_version' }, write_protocol: { t: 'number?' } },
  ...
  const CONCEPTS = [
    ...
    
    {
      ...
      fields: [
        ...
        { ux: 'Outcome', bridge: 'outcome', api: 'Status', note: 'Their set is richer: PASS, PASS_WITH_COMMENTS, FAILED, BLOCKED, ABORTED, plus PENDING_SIGN_OFF.' },
