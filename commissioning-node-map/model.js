  ...
  const CONCEPTS = [
    ...
    
    {
      ...
      fields: [
        ...
        { ux: 'Archived', bridge: 'archived_at', api: 'IsArchived / ArchivedOn', note: 'Closed 13 Sep. One nullable timestamp where theirs is a flag plus a date — the two halves cannot disagree, and it is the shape task_instance.archived_at already set. Enforced, not merely recorded: a trigger refuses to map an archived template onto an asset type, a system type or a step, so “cannot be applied to anything new” is true of the database and not only of the screen.' },
