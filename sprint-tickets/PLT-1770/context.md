...
- **#2088 was marked ready-for-review** (no longer draft). Not merged — still waiting for an
  approval.
  > **Correction (2026-08-06 triage run):** that was *this routine*, not Ilia. It was taken out
  > of draft because `brace-expansion@5.0.9` cleared the 7-day `min-release-age` buffer on
  > 2026-08-06 (published 2026-07-30T10:00Z), which its own PR body named as the only reason it
  > was parked. Flagged to Ilia as a deviation from "keep PRs in draft".
